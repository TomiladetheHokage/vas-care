...
<div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
    ...
    <form action="<?php echo BASE_URL; ?>/index.php?action=login" method="POST" class="space-y-5">
        <!-- Email -->
        <div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" onclick="togglePasswordVisibility()" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500">
                    <!-- Eye Open SVG -->
    ...
    <p class="mt-6 text-center text-sm text-gray-600">
        ...
        <a href="<?php echo BASE_URL; ?>/views/register.php" class="text-indigo-600 hover:underline font-medium">Register</a>
    </p>
</div>
